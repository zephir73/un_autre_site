<?php
require_once '/class/Bdd_Connection.php';
...
function Lecture_Client_Email_Mdp($email_client,$mdp_client)
{
	$bdd_connection = new Connection();
	$bdd=$bdd_connection->Bdd_get();
	...
	{	
	/*ID_Client 	Nom_Client 	Prenom_Client 	Nb_Tel_Fix_Client 	Nb_Tel_Port_Client 	Adresse_Client 	Ville_Client 	Cp_Client 	Email_Client 	Mdp_Client 	ID_Droit */
		$req=$bdd->prepare("SELECT ID_Client, Nom_Client, Prenom_Client, Nb_Tel_Fix_Client, Nb_Tel_Port_Client, Adresse_Client, Ville_Client, Cp_Client, Email_Client, Mdp_Client, ID_Droit FROM Client WHERE Email_Client='".$email_client."' AND Mdp_Client='".$mdp_client."';");
...
function Lecture_Client_Id($id_client)
{
	$bdd_connection = new Connection();
	$bdd=$bdd_connection->Bdd_get();
	...
	{	
	/*ID_Client 	Nom_Client 	Prenom_Client 	Nb_Tel_Fix_Client 	Nb_Tel_Port_Client 	Adresse_Client 	Ville_Client 	Cp_Client 	Email_Client 	Mdp_Client 	ID_Droit */
		$req=$bdd->prepare("SELECT ID_Client, Nom_Client, Prenom_Client, Nb_Tel_Fix_Client, Nb_Tel_Port_Client, Adresse_Client, Ville_Client, Cp_Client, Email_Client, Mdp_Client, ID_Droit FROM Client WHERE ID_Client=".$id_client.";");
